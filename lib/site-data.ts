...
export const site: SiteContent = {
  ...
  hero: {
    rotatingWords: ["ship", "scale", "last", "matter"],
    headlineLine1: "Solutions",
    headlineLine2Before: "that",
    availabilityLabel: "Available for work",
    introBeforeName: "I'm",
    introAfterName:
      ", a full stack developer in Luxor, Egypt. I build web applications end to end —",
  ...
  copy: {
    ...
    about: {
      index: "01",
      eyebrow: "About",
      titleBefore: "A developer who likes",
      titlePrefix: " the ",
      titleAccent: "whole",
      titleAfter: " stack.",
      titleBreak: true,
    ...
    contactBody:
      "I'm looking for full stack or .NET roles, and I'm happy to talk about freelance work too. Tell me what you're building — I usually reply within a day.",
...
export const heroStats = site.heroStats;
export const quickFacts = site.quickFacts;
export const coreStack = site.coreStack;
export const skillGroups = site.skillGroups;
...
export const learning = site.learning;
export const teaching = site.teaching;
export const languages = site.languages;
export const beyondCode = site.beyondCode;

export type { Project, SkillGroup, TimelineItem } from "@/lib/site-types";
